...
echo "EQUILIBRACIÓN A 400 K"
echo ""

# Variables
EQUI_MDP="equiNVT_400K.mdp"
...
if [ ! -f "$EQUI_MDP" ]; then
    echo "ERROR: No se encuentra $EQUI_MDP"
    exit 1
fi
...
# Script SLURM
cat > submit_equilibration_400K.sh <<'EOFSCRIPT'
#!/bin/bash
#SBATCH -p eck-q
...
chmod +x submit_equilibration_400K.sh
...
echo "  submit_equilibration_400K.sh   - Script para SLURM"
