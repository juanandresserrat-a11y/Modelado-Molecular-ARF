...
set output 'energia_total_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Energia Total (kJ/mol)'
set title 'Energia Total - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'energia_cinetica_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Energia Cinetica (kJ/mol)'
set title 'Energia Cinetica - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'temperatura_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Temperatura (K)'
set title 'Temperatura - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'gyrate_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Radio de Giro (nm)'
set title 'Radio de Giro - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'distancias_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Distancia (nm)'
set title 'Distancias de Enlace - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'angulos_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Angulo (grados)'
set title 'Angulos - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'velocidades_400K.png'
set xlabel 'Tiempo (ps)'
set ylabel 'Velocidad (nm/ps)'
set title 'Velocidades - 400K'
set grid
...
$GNUPLOT <<'EOF'
set terminal png size 1200,800
set output 'histograma_temperatura_400K.png'
set xlabel 'Temperatura (K)'
set ylabel 'Frecuencia'
set title 'Distribucion Temperatura - 400K'
